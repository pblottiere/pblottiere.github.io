...
A clear disadvantage of these solutions is the need of an external library,
...
<br/>
![Pie Chart]({{ site.baseurl }}/images/posts/qml/qtcharts.png){:class="center-image" width="400px"}
<br/>
...
<a href="https://github.com/pblottiere/pyqgis-bundle/qml/pie.py">script</a>
...
function addSlices() {
  pieChartId.clear()
  var sorted = sortValues(pypie.slices)
  var slices = {}
...
As a matter of interest, a self-sufficient pyqgis script is available on github to
draw pie charts for any vector layer using a rule-based renderer.
<br/>
<br/>
<br/>
<br/>
